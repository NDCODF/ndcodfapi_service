...
protected:
    ...
    static bool WebDAVEnabled;
    /// Allowed/denied WOPI hosts, if any and if WOPI is enabled.
    static Util::RegexListMatcher WopiHosts;
    /// Allowed/denied OTHER hosts, if any and if OTHER is enabled.
    static Util::RegexListMatcher OtherHosts;
};
...
public:
    ...
    StorageBase::FileInfo getWebDAVStorageFileInfo(const Poco::URI& uriPublic);
