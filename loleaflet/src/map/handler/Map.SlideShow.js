...
L.Map.SlideShow = L.Handler.extend({
	...
	_onFullScreen: function () {
		...
		// @TODO: msfullscreenchange need to remove?
		L.DomEvent.on(document, 'fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange MSFullscreenChange',
