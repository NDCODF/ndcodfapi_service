...
$.widget( "evol.colorpicker", {
	...
	_paletteHTML: function() {
		...
		var h='<div class="evo-pop'+_ie+' ui-widget ui-widget-content ui-corner-all"'+
			...
			// links
			'<div class="evo-more"><a href="javascript:void(0)">'+_(labels[1+pIdx])+'</a>';
		if(opts.history){
			h+='<a href="javascript:void(0)" class="evo-hist">'+_(labels[5])+'</a>';
		}
		h+='</div>';
		// indicator
	...
	_paletteHTML1: function() {
		...
		// base theme colors
		var h='<table class="evo-palette'+_ie+'">'+oTRTH+_(labels[0])+'</th></tr><tr>';
		for(var i=0;i<10;i++){ 
